...
def do_collect_samples(pid, env, policy, custom_reward,
...
class AgentCollection:
    ...
    def collect_samples(self, min_batch_size):
        ...
        for i in range(self.num_teachers):
            result_ids.append(do_collect_samples(i, self.envs[i], self.policies[i], self.custom_reward, self.mean_action,
