...
class HalfCheetahVelEnv_FL(HalfCheetahEnv):
    ...
    def step(self, action):
        ...
        infos = dict(reward_forward=forward_reward,
            reward_ctrl=-ctrl_cost, task={})
        return (observation, reward, done, infos)

class HalfCheetahEnv_Bias(HalfCheetahEnv):
    """Half-cheetah environment with biased rewards.
    """
    def __init__(self):
        self.bias = np.random.uniform(-0.5, 0.5)
        super(HalfCheetahEnv_Bias, self).__init__()
    ...
    def step(self, action):
        ...
        reward = reward_ctrl + reward_run + self.bias
        done = False
